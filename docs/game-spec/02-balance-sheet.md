...
> **Scope:** v1 출시 밸런스는 한 판 5~7분, 단일 맵, 단일 전투 재화, 선택형 광고 2곳만 다룬다.
...
| 첫 보스 도달 | 2~3분 |
| 초보 패배 | wave 8~10 |
| 익숙한 유저 패배 | wave 12~15 |
| 소환 빈도 | 초반 10~20초마다 의사결정 발생 |
| 핵심 보상 | 더 높은 tier 합성, 보스 카드 선택, 최고 wave 갱신 |

50 wave는 데이터 상한/디버그 구간으로 유지할 수 있지만, v1 밸런스 기준은 wave 15 안쪽이다.
...
기존 `WAVE_SCALING`과 slots 11+ 선형 공식은 유지하되, v1 테스트 기준은 wave 15까지다.
