...
import { ALL_TOWERS, BASE_TOWERS, RARE_TOWERS, HEROIC_TOWERS, LEGENDARY_TOWERS, GOD_TOWERS, getTowersByTier } from '../src/constants/towers';
...
describe('Tower definitions', () => {
  ...
  it('all non-T1 towers have cost 0 (obtained via merge)', () => {
    const nonT1 = [...RARE_TOWERS, ...HEROIC_TOWERS, ...LEGENDARY_TOWERS, ...GOD_TOWERS];
