...
프로젝트의 [`phaser-best-practices`](../../../.claude/skills/phaser-best-practices/SKILL.md) 기준으로 변경 코드를 본다. 해당 항목이 변경 코드에 실제로 적용될 때만 점수에 반영한다.
...
- [`phaser-best-practices`](../../../.claude/skills/phaser-best-practices/SKILL.md)
