...
> **Goal:** 리소스를 최소화하면서 지하철에서 5~7분 동안 하기 편한 캐주얼 랜덤 합성 타워디펜스를 출시한다.
...
|------|------|
| 첫 보스 도달 | 2~3분 |
| 일반 패배 지점 | 초보 wave 8~10, 익숙한 유저 wave 12~15 |
| 한 판 종료 | 5~7분 |
| 재시작 마찰 | 결과 화면에서 1탭 |

50 wave 데이터는 밸런스/디버그 상한으로 유지할 수 있지만, v1 UX의 목표는 12~15 wave 안의 짧은 완결감이다.
...
| wave 11~15 | 실패 압박, 최고 기록 경쟁 |
| wave 16+ | 숙련자/디버그/확장 구간 |
