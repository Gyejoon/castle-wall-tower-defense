...
export function inferAssetManifestSection(entry: Pick<AssetManifestEntry, 'key' | 'path'>): AssetManifestSection {
...
export function withManifestSection<T extends AssetManifestEntry>(entry: T): T & { section: AssetManifestSection } {
  return {
    ...entry,
...
export function withManifestSections<T extends AssetManifestEntry>(entries: T[]): Array<T & { section: AssetManifestSection }> {
