...
// generatePhaseAWaves moved to ../data/phaseAWaves.ts — imported above for
// STAGE_WAVES.phase_a_s1 seeding. Keep the import as the single consumer
// within this module; external callers should import from data/phaseAWaves.
