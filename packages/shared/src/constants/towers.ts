...
export const HEROIC_TOWERS: TowerDef[] = [
  ...
  },
  {
    ...
    type: 'wind_spire',
    tier: 3,
    stats: { damage: 20, range: 5, attackSpeed: 2.5, special: 'chain_3targets' },
    cost: 0,
    isPremium: false,
    color: '#7ed9a0',
    shape: 'diamond',
...
export const GOD_TOWERS: TowerDef[] = [
  {
    ...
    type: 'celestial',
    tier: 5,
    stats: { damage: 200, range: 5, attackSpeed: 1.0, special: 'splash_slow_burn' },
    cost: 0,
    isPremium: false,
    color: '#ffe870',
    shape: 'star',
  },
  {
    ...
    type: 'divine_throne',
    tier: 5,
    stats: { damage: 0, range: 999, attackSpeed: 0, special: 'boost_all_50%_heal' },
    cost: 0,
    isPremium: false,
    color: '#fff0b0',
    shape: 'star',
